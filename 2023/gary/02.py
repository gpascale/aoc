...
def main1():
  ...
  for line in lines:
    halves = line.split(': ')
    game = int(halves[0].split(' ')[1])
    plays = halves[1].split('; ')
    possible = True
    for play in plays:
      cubes = play.split(', ')
      for cube in cubes:
...
data = """Game 1: 14 green, 8 blue, 9 red; 5 blue, 4 green, 2 red; 4 red, 4 blue, 4 green; 1 blue, 3 green, 2 red; 10 red, 3 blue, 15 green; 2 red, 6 green, 3 blue
